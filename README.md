...
## 🧠 About Me (a.k.a. the situation)

- 🍵 Powered by tea, snacks, and questionable optimism  
- 💻 Currently juggling **Web Dev + Data Science + “I swear this side project will finish” energy**  
- 🚗 Building **Sangai** — a carpooling app (yes, it will work. yes, eventually.)  
- 🎮 Gaming, music, and overthinking UI spacing at 3AM  
- 🌍 Based in Nepal, mentally sometimes inside a Git commit message  

---

## 🛠️ Tech Stack (aka my emotional support tools)

I use whatever works… and then refuse to let it go:

### Languages & Core Stuff
...
### Data / ML “I’ll train this model for fun” era
...
- I refactor my README more than my actual production code  
- “Quick fix” is my favorite lie  
